...
import com.huy.security.CustomAccessDeniedHandler;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  @ExceptionHandler(TimestampNotExistsException.class)
  public ResponseEntity<?> timestampNotExistsException(TimestampNotExistsException ex, WebRequest request) {
    Map<String, String> body = new HashMap<>();

    body.put("ts", Boolean.FALSE.toString());
    body.put("message", ex.getMessage());
